...
.styled-text.underline{{text-decoration:underline;text-decoration-thickness:1px;text-underline-offset:1.5px}}
...
.styled-text.border .styled-text.highlight,.styled-text.circle .styled-text.highlight{{padding:0;border-radius:0}}
...
.styled-text.wavyunderline{{text-decoration:underline wavy;text-decoration-thickness:1px;text-underline-offset:1.5px}}
